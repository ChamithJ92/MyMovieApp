...
class NowPlayingMovieAdapter(private val listener: OnItemClickListenerNP):
    RecyclerView.Adapter<NowPlayingMovieAdapter.NowPlayingMovieViewHolder>() {

    inner class NowPlayingMovieViewHolder(itemView: View) :
    ...
    interface OnItemClickListenerNP{
        fun onItemClickNP(movieData: MovieData)
    }
}