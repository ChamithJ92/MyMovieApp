...
class SearchMovieAdapter(private val listener: OnItemClickListenerSM)
    : RecyclerView.Adapter<SearchMovieAdapter.SearchMovieViewHolder>() {

    inner class SearchMovieViewHolder(itemView: View)
    ...
    interface OnItemClickListenerSM{
        fun onItemClickSM(movieData: MovieData)
    }
}